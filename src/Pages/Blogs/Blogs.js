...
const Blogs = () => {
  return (
    <div className="blog-container w-80">
      ...
      <div className="single-blog">
        ...
        <p>
          <span className="answare-keyword">Answare:</span> We can improve the
      ...
      <div className="single-blog">
        ...
        <p>
          <span className="answare-keyword">Answare:</span> We know that there are
      ...
      <div className="single-blog">
        ...
        <p>
          <span className="answare-keyword">Answare:</span> The Prototypal
      ...
      <div className="single-blog">
        ...
        <p>
          <span className="answare-keyword">Answare:</span> We should never update
      ...
      <div className="single-blog">
        ...
        <p>
          <span className="answare-keyword">Answare:</span> There are some different
      ...
      <div className="single-blog">
        ...
        <p>
          <span className="answare-keyword">Answare:</span> The Unit tests are some
